<form method="POST" action="./Source/Database/query.php" class="row g-3">
  <div class="col-md-6">
    ...
    <input type="text" name="name" placeholder="Digite aqui o seu nome.." id="campo_nome" onfocus="clicou_campo_nome()" onblur="nao_clicou_campo_nome()" class="form-control">
  </div>
  <div class="col-md-6">
    <label class="form-label">Email:</label>
    <input type="email" name="email" placeholder="Digite aqui o seu email..." id="campo_email" onfocus="clicou_campo_email()" onblur="nao_clicou_campo_email()" class="form-control">
  </div><br><br><br><br>
  <div class="col-md-6">
    <label class="form-label">Mensagem:</label>
    <textarea type="text" maxlength="1000" minlength="1" name="message" style="height: 150px;" placeholder="Digite aqui sua mensagem..." id="campo_msg" onfocus="clicou_campo_msg()" onblur="nao_clicou_campo_msg()" class="form-control"></textarea>
  </div>
  <div class="col-12">

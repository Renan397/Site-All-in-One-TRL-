<form method="POST" action="./Source/Database/query.php" class="row g-3">
  ...
  <div class="col-md-6">
    ...
    <textarea type="text" maxlength="1000" required="required" minlength="1" name="message" style="height: 150px;" placeholder="Digite aqui sua mensagem..." id="campo_msg" onfocus="clicou_campo_msg()" onblur="nao_clicou_campo_msg()" class="form-control"></textarea>
  </div>
  <div class="col-12">

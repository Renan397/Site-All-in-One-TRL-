...
$txt_servicos = "Primeiramente, você está totalmente satisfeito com o rendimento do seu negócio? Bem, se a resposta for sim, você está no lugar certo, já se a resposta for não, você também está no lugar certo. Por que? A TRL pode te oferecer um site, totalmente moderno, com estilização e banco de dados integrados, esse site vai te ajudar a alavancar suas vendas, visto que muitas pessoas poderiam ver as ofertas da suas empresa ou entrar em contato com a mesma, apenas com um toque na tela do celular ou um clique na tela do computador. E a consultoria? <b>Totalmente gratuita!</b> Disponilizamos esse serviço para que você tenha a garantia de que vai ter um bom produto, e sem gastos iniciais. Já imaginou suas vendas subindo a cada clique de um novo cliente? Pois então veja abaixo nossas ofertas, caso surja o interesse, preencha o formulário no fim da página, será um prazer ajudá-lo!";
